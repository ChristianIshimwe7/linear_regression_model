from fastapi import FastAPI, HTTPException
   ...
   def get_risk_description(prediction: float) -> str:
       if prediction < 0.33:
           return "Low Risk: The predicted risk score indicates a low likelihood of birth defects. Continue regular prenatal care."
       elif prediction < 0.67:
           return "Moderate Risk: The predicted risk score indicates a moderate likelihood of birth defects. Consult a healthcare provider for further evaluation."
       else:
           return "High Risk: The predicted risk score indicates a high likelihood of birth defects. Immediate consultation with a healthcare provider is recommended."
   ...
   async def predict(data: PredictionInput):
       ...
       description = get_risk_description(prediction)
       return {
